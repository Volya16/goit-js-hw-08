...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=document.querySelector("iframe"),ep=new B(eh),ev="videoplayer-current-time";ep.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function(e){let t=e.seconds;localStorage.setItem(ev,JSON.stringify(t))},1e3));const ey=JSON.parse(localStorage.getItem(ev));console.log(ey),ep.setCurrentTime(ey);//# sourceMappingURL=02-video.1e2e31cd.js.map

//# sourceMappingURL=02-video.1e2e31cd.js.map
