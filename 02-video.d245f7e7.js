...
"[object Array]"!=r.call(e)?t.reject(TypeError("Not an array")):new t(function(n,r){if("function"!=typeof n||"function"!=typeof r)throw TypeError("Not a function");s(t,e,function(e,t){n(t)},r)}))}),h)}(),e.exports&&(e.exports=N[t]),n.exports),L=new WeakMap;/**
...
if(Y.has(e))return Y.get(e);this._window=e.ownerDocument.defaultView,this.element=e,this.origin="*";var a=new C(function(t,n){if(r._onMessage=function(e){if(j(e.origin)&&r.element.contentWindow===e.source){"*"===r.origin&&(r.origin=e.origin);var o=q(e.data);if(o&&"error"===o.event&&o.data&&"ready"===o.data.method){var i=Error(o.data.message);i.name=o.data.name,n(i);return}var a=o&&"ready"===o.event,u=o&&"ping"===o.method;if(a||u){r.element.setAttribute("data-ready","true"),t();return}!/**
...
r.ready().then(function(){V(r,"fullscreenchange",Q.isFullscreen)})},Q.on("fullscreenchange",this.fullscreenchangeHandler)}return this}return(/**
   ...
   * @return {Promise}
   */v(t,[{key:"callMethod",value:function(e){var t=this,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return new C(function(r,o){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return t.ready().then(function(){A(t,e,{resolve:r,reject:o}),V(t,e,n)}).catch(o)})}},{key:"get",value:function(e){var t=this;return new C(function(n,r){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return e=T(e,"get"),t.ready().then(function(){A(t,e,{resolve:n,reject:r}),V(t,e)}).catch(r)})}},{key:"set",value:function(e,t){var n=this;return new C(function(r,o){if(e=T(e,"set"),null==t)throw TypeError("There must be a value to set.");// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=document.querySelector("iframe"),ep=new B(eh);ep.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function(e){let t=e.seconds;localStorage.setItem("videoplayer-current-time",JSON.stringify(t))}//# sourceMappingURL=02-video.d245f7e7.js.map
,1e3));
//# sourceMappingURL=02-video.d245f7e7.js.map
