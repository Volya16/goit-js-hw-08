 ...
 * @type {Boolean}
 *//* global global */var P=void 0!==u&&"[object global]"===({}).toString.call(u);/**
 ...
 */var M=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"addEventListener",o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"removeEventListener",i="string"==typeof t?[t]:t;return i.forEach(function(t){e[r](t,n)}),{cancel:function(){return i.forEach(function(t){return e[o](t,n)})}}},N=void 0!==Array.prototype.indexOf,C="undefined"!=typeof window&&void 0!==window.postMessage;if(!P&&(!N||!C))throw Error("Sorry, the Vimeo Player API is not available in this browser.");var F="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==u?u:"undefined"!=typeof self?self:{};!/*!
...
"[object Array]"!=r.call(e)?t.reject(TypeError("Not an array")):new t(function(n,r){if("function"!=typeof n||"function"!=typeof r)throw TypeError("Not a function");f(t,e,function(e,t){n(t)},r)}))}),p)}(),e.exports&&(e.exports=F[t]),n.exports),A=new WeakMap;/**
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=eh(t)||0,ed(n)&&(s=!!n.leading,i=(f="maxWait"in n)?el(eh(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(ef())},m}(e,t,{leading:r,maxWait:t,trailing:o})};var ep=document.querySelector("iframe"),ev=new J(ep),ey="videoplayer-current-time";ev.on("timeupdate",((a=X)&&a.__esModule?a.default:a)(function(e){var t=e.seconds;localStorage.setItem(ey,JSON.stringify(t))},1e3));var em=JSON.parse(localStorage.getItem(ey));console.log(em),ev.setCurrentTime(em)}();//# sourceMappingURL=02-video.aeb2bf4d.js.map

//# sourceMappingURL=02-video.aeb2bf4d.js.map
